...
Scalar color = frame.at<uchar>(Point(i,j));
if(bw.val[0]==255)
{
	if(~(color.val[0] > 2*color.val[1] && color.val[0] > 2*color.val[2]) || (color.val[1] > 2*color.val[0] && color.val[1] > 2*color.val[2]) || (color.val[2] > 2*color.val[0] && color.val[2] > 2*color.val[1]))
	{
